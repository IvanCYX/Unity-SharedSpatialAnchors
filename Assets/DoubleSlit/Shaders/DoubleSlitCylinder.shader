Shader "Unlit/DoubleSlitCylinder" {
    Properties {
        //Quality properties 
        [Header(Quality)]
        ...
        _spreadStart ("Spread Start", Range(0.1, 1)) = 1
        _spreadCoefficient ("Spread Start", Range(1, 2)) = 1
    ...
    SubShader {
        ...
        Pass {
            ...
            float GaussianPlaneWave(float3 position) {
                ...
                return PlaneWave(position) * exp(-_gaussianCoefficient*(position.x * position.x));
            }
